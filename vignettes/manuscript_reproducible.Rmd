...
```{r}
pt26sozName <- rownames(pt26sz1Cropped)[rowData(pt26sz1Cropped)$soz]
...
pt26Display <- c(
    ...
    excludedElectrodes,
    pt26sozName[17:18])
pt26sz1Reordered <- pt26sz1Cropped[pt26Display, ]
...
```
Setting the "ranked" variable to TRUE in the plot allows more contrast and render the heatmap closer to original figure 4.
```{r}
